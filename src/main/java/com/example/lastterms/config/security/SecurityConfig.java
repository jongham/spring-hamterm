...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.httpBasic().disable().csrf().disable().sessionManagement()
                ...
                .authorizeRequests().antMatchers("/sign-api/sing-in", "/sign-api/sing-up", "/sign-api/exception", "/product/list", "Board/list").permitAll()
                .antMatchers(HttpMethod.GET, "/user/**").permitAll()
                .antMatchers("**exception**").permitAll()
                .antMatchers("/product/insert", "/product/delete", "/product/update").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/order/**").hasRole("ADMIN")
                .antMatchers( "/user/**").hasRole("ADMIN")
                .antMatchers( "/order/insert").hasRole("USER")
                .antMatchers( "/Board/insert").hasAnyRole("ADMIN","USER")
